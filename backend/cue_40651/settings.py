"""
Django settings for cue_40651 project.
...
WSGI_APPLICATION = 'cue_40651.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cue_40651 API",
    "DESCRIPTION": "API documentation for cue_40651 App",
    "VERSION": "v1",
}
